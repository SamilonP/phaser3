...
class level2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.platforms.create(100, 590, 'ground').setScale(2, 1).refreshBody()
        this.platforms.create(380, 580, 'ground').setScale(2, 1).refreshBody()
        this.platforms.create(500, 535, 'ground').setScale(2, 1).refreshBody()
        this.platforms.create(700, 500, 'ground')
        this.platforms.create(900, 500, 'ground')
        this.platforms.create(1100, 500, 'ground')
        this.platforms.create(1400, 500, 'ground').setScale(3, 1).refreshBody()
        ...
        this.player = this.physics.add.sprite(100, 530, 'peguig').setOrigin(0.5, 0.5)
