class level3 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('sky', 'assets/skyer.png')
        ...
        this.load.audio('music', 'assets/fourti.wav')
    ...
    create() {
        ...
        this.platforms.create(100, 540, 'ground')
        this.platforms.create(200, 500, 'ground')
        this.platforms.create(350, 460, 'ground')
        this.platforms.create(540, 420, 'ground')
        this.platforms.create(770, 380, 'ground')
        this.platforms.create(1400, 505, 'ground')

        this.finishFlag = this.physics.add.image(1400, 450, 'flag')
        this.finishFlag.body.setAllowGravity(false)
        this.speechCube = this.add.container(200, 200)

        this.player = this.physics.add.sprite(100, 480, 'peguig').setOrigin(0.5, 0.5)
        ...
        this.dialog = [
            "usually id leave this place at this point",
        ...
        for (let i = 0; i < this.dialog.length; i++) {
            ...
            this.time.delayedCall(i * 2000 + 2000, () => {
                this.dialogText = this.add.text(0, -50 + (i * 20), this.dialog[i], {
